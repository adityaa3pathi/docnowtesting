...
router.post('/items', auth_1.authMiddleware, async (req, res) => {
    try {
...
router.put('/items/:id', auth_1.authMiddleware, async (req, res) => {
    try {
...
router.delete('/items/:id', auth_1.authMiddleware, async (req, res) => {
    try {
        const id = req.params.id;
