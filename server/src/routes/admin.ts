...
router.get('/health', authMiddleware, requireSuperAdmin, (req: AuthRequest, res: Response) => {
...
router.get('/stats', authMiddleware, requireSuperAdmin, async (req: AuthRequest, res: Response) => {
    try {
...
router.get('/users', authMiddleware, requireSuperAdmin, async (req: AuthRequest, res: Response) => {
    try {
...
router.get('/users/:id', authMiddleware, requireSuperAdmin, async (req: AuthRequest, res: Response) => {
    try {
...
router.put('/users/:id/status', authMiddleware, requireSuperAdmin, async (req: AuthRequest, res: Response) => {
    try {
        const userId = req.params.id as string;
...
router.get('/config', authMiddleware, requireSuperAdmin, async (req: AuthRequest, res: Response) => {
    try {
...
router.put('/config/:key', authMiddleware, requireSuperAdmin, async (req: AuthRequest, res: Response) => {
    try {
...
router.post('/wallets/adjust', authMiddleware, requireSuperAdmin, async (req: AuthRequest, res: Response) => {
    try {
...
router.get('/wallets/ledger', authMiddleware, requireSuperAdmin, async (req: AuthRequest, res: Response) => {
    try {
        const page = parseInt(req.query.page as string) || 1;
        const limit = parseInt(req.query.limit as string) || 20;
...
router.get('/referrals/stats', authMiddleware, requireSuperAdmin, async (req: AuthRequest, res: Response) => {
    try {
        const [
            totalReferrals,
            rewardsDistributed,
...
router.get('/orders', authMiddleware, requireSuperAdmin, async (req: AuthRequest, res: Response) => {
    try {
        const page = parseInt(req.query.page as string) || 1;
        const limit = parseInt(req.query.limit as string) || 20;
        const search = req.query.search as string;
...
router.get('/stats/revenue', authMiddleware, requireSuperAdmin, async (req: AuthRequest, res: Response) => {
    try {
...
router.get('/stats/high-value', authMiddleware, requireSuperAdmin, async (req: AuthRequest, res: Response) => {
    try {
        const orders = await prisma.booking.findMany({
...
router.get('/audit-logs', authMiddleware, requireSuperAdmin, async (req: AuthRequest, res: Response) => {
    try {
        const page = parseInt(req.query.page as string) || 1;
        const limit = parseInt(req.query.limit as string) || 20;
        const search = req.query.search as string;
