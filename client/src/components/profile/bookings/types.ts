...
export const STATUS_MAP: Record<string, { label: string, color: string, step: number }> = {
    ...
    'BS003': { label: 'Cancelled', color: 'bg-red-100 text-red-700', step: 0 },
    'BS005': { label: 'Sample Collector Assigned', color: 'bg-purple-100 text-purple-700', step: 3 },
    'BS007': { label: 'Sample Collected', color: 'bg-indigo-100 text-indigo-700', step: 4 },
    'BS008': { label: 'Sample Received at Lab', color: 'bg-indigo-100 text-indigo-700', step: 4 },
    'BS0013': { label: 'Rescheduled', color: 'bg-yellow-100 text-yellow-700', step: 2 },
    'BS0018': { label: 'Resample Required', color: 'bg-red-100 text-red-700', step: 2 },
